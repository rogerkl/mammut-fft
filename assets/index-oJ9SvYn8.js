(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const P="modulepreload",$=function(s){return"/mammut-fft/"+s},g={},F=function(e,t,o){let i=Promise.resolve();if(t&&t.length>0){let a=function(c){return Promise.all(c.map(d=>Promise.resolve(d).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=n?.nonce||n?.getAttribute("nonce");i=a(t.map(c=>{if(c=$(c),c in g)return;g[c]=!0;const d=c.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const h=document.createElement("link");if(h.rel=d?"stylesheet":P,d||(h.as="script"),h.crossOrigin="",h.href=c,l&&h.setAttribute("nonce",l),document.head.appendChild(h),d)return new Promise((f,m)=>{h.addEventListener("load",f),h.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(a){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=a,window.dispatchEvent(n),!n.defaultPrevented)throw a}return i.then(a=>{for(const n of a||[])n.status==="rejected"&&r(n.reason);return e().catch(r)})};class x{static wasmModule=null;static initPromise=null;static async initialize(){if(this.initPromise)return this.initPromise;this.initPromise=this.loadWasm(),await this.initPromise}static async loadWasm(){const{default:e,WasmAudioProcessor:t}=await F(async()=>{const{default:o,WasmAudioProcessor:i}=await import("./mammut_fft_web-COZAoB5Y.js");return{default:o,WasmAudioProcessor:i}},[]);await e(),this.wasmModule={WasmAudioProcessor:t}}static createProcessor(){if(!this.wasmModule)throw new Error("WASM module not initialized");return new this.wasmModule.WasmAudioProcessor}}class q extends EventTarget{processor;audioContext=null;currentFileName="";hasUnprocessedOperations=!1;constructor(){super(),this.processor=x.createProcessor()}async loadAudioFile(e,t){this.currentFileName=e.name,this.hasUnprocessedOperations=!1,this.audioContext||(this.audioContext=new AudioContext);const o=await e.arrayBuffer(),i=new Uint8Array(o);try{this.processor.read_audio_bytes(i,t),this.dispatchEvent(new CustomEvent("audioLoaded",{detail:{fileName:e.name,info:this.getInfo()}}))}catch(r){throw new Error(`Failed to load audio: ${r}`)}}getInfo(){return this.processor.get_info()}getSpectrumData(e,t,o){return this.processor.get_spectrum_data(e,t,o)}async processAudio(){this.processor.perform_ifft(),this.hasUnprocessedOperations=!1;const e=this.processor.get_processed_audio_normalized();if(!this.audioContext)throw new Error("Audio context not initialized");const t=this.getInfo(),o=t.channels,i=e.length/o,r=this.audioContext.createBuffer(o,i,t.sample_rate);for(let a=0;a<o;a++){const n=r.getChannelData(a);for(let l=0;l<i;l++)n[l]=e[l*o+a]}return this.audioBufferToWav(r)}downloadProcessedAudio(e){let t=!1;this.hasUnprocessedOperations&&(console.log("Audio operations detected - performing inverse FFT before download..."),this.processor.perform_ifft(),this.hasUnprocessedOperations=!1,t=!0);const o=this.processor.save_to_wav_bytes(),i=new Blob([o],{type:"audio/wav"}),r=URL.createObjectURL(i),a=e||(this.currentFileName?`${this.currentFileName.replace(/\.[^/.]+$/,"")}_processed.wav`:"processed_audio.wav"),n=document.createElement("a");return n.href=r,n.download=a,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(r),{wasProcessed:t}}reset(){this.processor.reset(),this.hasUnprocessedOperations=!1,this.dispatchEvent(new Event("reset"))}applyPower(e){this.processor.apply_pow(e),this.dispatchEvent(new Event("operationApplied"))}applyLowpass(e){this.processor.apply_lowpass(e),this.dispatchEvent(new Event("operationApplied"))}applyHighpass(e){this.processor.apply_highpass(e),this.dispatchEvent(new Event("operationApplied"))}applyBandpass(e,t){this.processor.apply_bandpass(e,t),this.dispatchEvent(new Event("operationApplied"))}audioBufferToWav(e){const t=e.numberOfChannels,o=e.length*t*2,i=e.sampleRate,r=new ArrayBuffer(44+o),a=new DataView(r),n=(c,d)=>{for(let p=0;p<d.length;p++)a.setUint8(c+p,d.charCodeAt(p))};n(0,"RIFF"),a.setUint32(4,36+o,!0),n(8,"WAVE"),n(12,"fmt "),a.setUint32(16,16,!0),a.setUint16(20,1,!0),a.setUint16(22,t,!0),a.setUint32(24,i,!0),a.setUint32(28,i*t*2,!0),a.setUint16(32,t*2,!0),a.setUint16(34,16,!0),n(36,"data"),a.setUint32(40,o,!0);let l=44;for(let c=0;c<e.length;c++)for(let d=0;d<t;d++){const p=Math.max(-1,Math.min(1,e.getChannelData(d)[c])),h=p<0?p*32768:p*32767;a.setInt16(l,h,!0),l+=2}return r}destroy(){this.processor.free()}dispatchOperationApplied(){this.hasUnprocessedOperations=!0,this.dispatchEvent(new Event("operationApplied"))}applyPhaseMultiply(e){this.processor.apply_phase_multiply(e),this.dispatchOperationApplied()}applySpectrumShift(e){this.processor.apply_spectrum_shift(e),this.dispatchOperationApplied()}applyStretch(e){this.processor.apply_stretch(e),this.dispatchEvent(new Event("operationApplied"))}applyWobble(e,t){this.processor.apply_wobble(e,t),this.dispatchOperationApplied()}applyThreshold(e,t){this.processor.apply_threshold(e,t),this.dispatchOperationApplied()}applyAmplitudeDerivative(e){this.processor.apply_amplitude_derivative(e),this.dispatchOperationApplied()}keepPeaks(){this.processor.keep_peaks(),this.dispatchOperationApplied()}swapBins(e,t){this.processor.swap_bins(e,t),this.dispatchOperationApplied()}swapChannels(e){this.processor.swap_channels(e),this.dispatchOperationApplied()}applyChordFilter(e,t,o,i){if(e.length!==5||t.length!==5)throw new Error("Chord filter requires exactly 5 frequencies and amplitudes");this.processor.apply_chord_filter(e[0],t[0],e[1],t[1],e[2],t[2],e[3],t[3],e[4],t[4],o,i),this.dispatchOperationApplied()}prepareSplitPart(e,t,o,i,r,a){this.processor.prepare_split_part(e,t,o,i,r,a)}resetSplit(){this.processor.reset_split()}async convolveWithFile(e,t,o){this.processor.convolve_with_file(e,t,o),this.dispatchOperationApplied()}}class B extends HTMLElement{audioService;constructor(){super(),this.audioService=new q}connectedCallback(){this.render(),this.setupEventListeners()}disconnectedCallback(){this.audioService.destroy()}render(){this.innerHTML=`
    ...
    `}setupCanvas(){this.canvas=this.shadowRoot.getElementById("spectrumCanvas"),this.ctx=this.canvas.getContext("2d"),new ResizeObserver(t=>{for(const o of t){const{width:i}=o.contentRect;this.canvas.width=i,this.updateSpectrum(this.audioService)}}).observe(this.canvas)}updateSpectrum(e){if(this.audioService=e,!e){y(this.ctx,this.canvas.width,this.canvas.height);return}try{const t=e.getInfo(),o=this.canvas.width,i=e.getSpectrumData(0,o,!0);O(this.ctx,this.canvas.width,this.canvas.height,i,t)}catch(t){console.error("Error drawing spectrum:",t),y(this.ctx,this.canvas.width,this.canvas.height)}}}customElements.define("spectrum-visualizer",R);class u extends HTMLElement{root;audioService=null;controls=new Map;constructor(){super(),this.root=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupEventListeners()}setAudioService(e){this.audioService=e}render(){const e=this.getConfig();this.root.innerHTML=`
      <style>
        ${this.getStyles()}
      </style>
