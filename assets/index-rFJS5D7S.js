(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const L="modulepreload",$=function(s){return"/mammut-fft/"+s},g={},F=function(e,t,o){let i=Promise.resolve();if(t&&t.length>0){let a=function(c){return Promise.all(c.map(d=>Promise.resolve(d).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=n?.nonce||n?.getAttribute("nonce");i=a(t.map(c=>{if(c=$(c),c in g)return;g[c]=!0;const d=c.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const h=document.createElement("link");if(h.rel=d?"stylesheet":L,d||(h.as="script"),h.crossOrigin="",h.href=c,l&&h.setAttribute("nonce",l),document.head.appendChild(h),d)return new Promise((f,m)=>{h.addEventListener("load",f),h.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(a){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=a,window.dispatchEvent(n),!n.defaultPrevented)throw a}return i.then(a=>{for(const n of a||[])n.status==="rejected"&&r(n.reason);return e().catch(r)})};class x{static wasmModule=null;static initPromise=null;static async initialize(){if(this.initPromise)return this.initPromise;this.initPromise=this.loadWasm(),await this.initPromise}static async loadWasm(){const{default:e,WasmAudioProcessor:t}=await F(async()=>{const{default:o,WasmAudioProcessor:i}=await import("./mammut_fft_web-COZAoB5Y.js");return{default:o,WasmAudioProcessor:i}},[]);await e(),this.wasmModule={WasmAudioProcessor:t}}static createProcessor(){if(!this.wasmModule)throw new Error("WASM module not initialized");return new this.wasmModule.WasmAudioProcessor}}class q extends EventTarget{processor;audioContext=null;currentFileName="";hasUnprocessedOperations=!1;constructor(){super(),this.processor=x.createProcessor()}async loadAudioFile(e,t){this.currentFileName=e.name,this.hasUnprocessedOperations=!1,this.audioContext||(this.audioContext=new AudioContext);const o=await e.arrayBuffer(),i=new Uint8Array(o);try{this.processor.read_audio_bytes(i,t),this.dispatchEvent(new CustomEvent("audioLoaded",{detail:{fileName:e.name,info:this.getInfo()}}))}catch(r){throw new Error(`Failed to load audio: ${r}`)}}getInfo(){return this.processor.get_info()}getSpectrumData(e,t,o){return this.processor.get_spectrum_data(e,t,o)}async processAudio(){this.processor.perform_ifft(),this.hasUnprocessedOperations=!1;const e=this.processor.get_processed_audio_normalized();if(!this.audioContext)throw new Error("Audio context not initialized");const t=this.getInfo(),o=t.channels,i=e.length/o,r=this.audioContext.createBuffer(o,i,t.sample_rate);for(let a=0;a<o;a++){const n=r.getChannelData(a);for(let l=0;l<i;l++)n[l]=e[l*o+a]}return this.audioBufferToWav(r)}downloadProcessedAudio(e){let t=!1;this.hasUnprocessedOperations&&(console.log("Audio operations detected - performing inverse FFT before download..."),this.processor.perform_ifft(),this.hasUnprocessedOperations=!1,t=!0);const o=this.processor.save_to_wav_bytes(),i=new Blob([o],{type:"audio/wav"}),r=URL.createObjectURL(i),a=e||(this.currentFileName?`${this.currentFileName.replace(/\.[^/.]+$/,"")}_processed.wav`:"processed_audio.wav"),n=document.createElement("a");return n.href=r,n.download=a,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(r),{wasProcessed:t}}reset(){this.processor.reset(),this.hasUnprocessedOperations=!1,this.dispatchEvent(new Event("reset"))}applyPower(e){this.processor.apply_pow(e),this.dispatchEvent(new Event("operationApplied"))}applyLowpass(e){this.processor.apply_lowpass(e),this.dispatchEvent(new Event("operationApplied"))}applyHighpass(e){this.processor.apply_highpass(e),this.dispatchEvent(new Event("operationApplied"))}applyBandpass(e,t){this.processor.apply_bandpass(e,t),this.dispatchEvent(new Event("operationApplied"))}audioBufferToWav(e){const t=e.numberOfChannels,o=e.length*t*2,i=e.sampleRate,r=new ArrayBuffer(44+o),a=new DataView(r),n=(c,d)=>{for(let p=0;p<d.length;p++)a.setUint8(c+p,d.charCodeAt(p))};n(0,"RIFF"),a.setUint32(4,36+o,!0),n(8,"WAVE"),n(12,"fmt "),a.setUint32(16,16,!0),a.setUint16(20,1,!0),a.setUint16(22,t,!0),a.setUint32(24,i,!0),a.setUint32(28,i*t*2,!0),a.setUint16(32,t*2,!0),a.setUint16(34,16,!0),n(36,"data"),a.setUint32(40,o,!0);let l=44;for(let c=0;c<e.length;c++)for(let d=0;d<t;d++){const p=Math.max(-1,Math.min(1,e.getChannelData(d)[c])),h=p<0?p*32768:p*32767;a.setInt16(l,h,!0),l+=2}return r}destroy(){this.processor.free()}dispatchOperationApplied(){this.hasUnprocessedOperations=!0,this.dispatchEvent(new Event("operationApplied"))}applyPhaseMultiply(e){this.processor.apply_phase_multiply(e),this.dispatchOperationApplied()}applySpectrumShift(e){this.processor.apply_spectrum_shift(e),this.dispatchOperationApplied()}applyStretch(e){this.processor.apply_stretch(e),this.dispatchEvent(new Event("operationApplied"))}applyWobble(e,t){this.processor.apply_wobble(e,t),this.dispatchOperationApplied()}applyThreshold(e,t){this.processor.apply_threshold(e,t),this.dispatchOperationApplied()}applyAmplitudeDerivative(e){this.processor.apply_amplitude_derivative(e),this.dispatchOperationApplied()}keepPeaks(){this.processor.keep_peaks(),this.dispatchOperationApplied()}swapBins(e,t){this.processor.swap_bins(e,t),this.dispatchOperationApplied()}swapChannels(e){this.processor.swap_channels(e),this.dispatchOperationApplied()}applyChordFilter(e,t,o,i){if(e.length!==5||t.length!==5)throw new Error("Chord filter requires exactly 5 frequencies and amplitudes");this.processor.apply_chord_filter(e[0],t[0],e[1],t[1],e[2],t[2],e[3],t[3],e[4],t[4],o,i),this.dispatchOperationApplied()}prepareSplitPart(e,t,o,i,r,a){this.processor.prepare_split_part(e,t,o,i,r,a)}resetSplit(){this.processor.reset_split()}async convolveWithFile(e,t,o){this.processor.convolve_with_file(e,t,o),this.dispatchOperationApplied()}}class B extends HTMLElement{audioService;constructor(){super(),this.audioService=new q}connectedCallback(){this.render(),this.setupEventListeners()}disconnectedCallback(){this.audioService.destroy()}render(){this.innerHTML=`
    ...
    `,this.fileInput=this.shadowRoot.getElementById("audioFile"),this.bufferMultiplierInput=this.shadowRoot.getElementById("bufferMultiplier")}setupEventListeners(){const e=this.shadowRoot.getElementById("uploadSection");this.shadowRoot.getElementById("uploadButton").addEventListener("click",()=>{this.fileInput.click()}),this.fileInput.addEventListener("change",o=>{const i=o.target;i.files?.length&&this.handleFile(i.files[0])}),["dragenter","dragover","dragleave","drop"].forEach(o=>{e.addEventListener(o,this.preventDefaults)}),["dragenter","dragover"].forEach(o=>{e.addEventListener(o,()=>{e.classList.add("drag-over")})}),["dragleave","drop"].forEach(o=>{e.addEventListener(o,()=>{e.classList.remove("drag-over")})}),e.addEventListener("drop",o=>{const i=o.dataTransfer;i?.files.length&&this.handleFile(i.files[0])})}preventDefaults(e){e.preventDefault(),e.stopPropagation()}handleFile(e){const t=this.shadowRoot.getElementById("fileInfo"),o=(e.size/1024).toFixed(1);t.textContent=`Selected: ${e.name} (${o} KB)`;const i=parseInt(this.bufferMultiplierInput.value);this.dispatchEvent(new CustomEvent("fileSelected",{detail:{file:e,bufferMultiplier:i},bubbles:!0,composed:!0}))}}customElements.define("file-uploader",T);class M extends HTMLElement{root;audio;resetButton;downloadButton;isProcessed=!1;isProcessing=!1;constructor(){super(),this.root=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.root.innerHTML=`
      <style>
        :host {
          display: block;
          margin: 25px 0;
    ...
    `,this.audio=this.root.getElementById("audioPlayer"),this.resetButton=this.root.getElementById("resetButton"),this.downloadButton=this.root.getElementById("downloadButton")}setupEventListeners(){this.audio.addEventListener("play",async e=>{!this.isProcessed&&!this.isProcessing&&(this.audio.pause(),await this.processAudio(),this.isProcessed&&this.audio.play())}),this.resetButton.addEventListener("click",()=>{this.resetAudio()}),this.downloadButton.addEventListener("click",()=>{this.dispatchEvent(new Event("downloadAudio",{bubbles:!0,composed:!0}))})}async processAudio(){if(!this.isProcessing){this.isProcessing=!0,this.audio.classList.add("processing");try{const e=new CustomEvent("processAudio",{bubbles:!0,composed:!0,detail:{callback:this.onProcessingComplete.bind(this)}});this.dispatchEvent(e)}catch(e){console.error("Processing failed:",e),this.onProcessingComplete(!1)}}}onProcessingComplete(e=!0){this.isProcessing=!1,this.isProcessed=e,this.audio.classList.remove("processing")}resetAudio(){this.isProcessed=!1,this.dispatchEvent(new Event("resetAudio",{bubbles:!0,composed:!0}))}updateAudio(e){const t=new Blob([e],{type:"audio/wav"}),o=URL.createObjectURL(t);this.audio.src&&this.audio.src.startsWith("blob:")&&URL.revokeObjectURL(this.audio.src),this.audio.src=o,this.onProcessingComplete(!0)}setEnabled(e){this.resetButton.disabled=!e,this.downloadButton.disabled=!e}resetProcessed(){this.isProcessed=!1}setOriginalAudio(e){this.isProcessed=!1,this.updateAudio(e)}}customElements.define("audio-player",M);function I(s,e,t,o,i){if(s.fillStyle="#2a2a2a",s.fillRect(0,0,e,t),!o||o.length===0){S(s,e,t,"No spectrum data available");return}k(s,e,t),E(s,t),A(s,e,t,i);const r=z(o,3),a=s.createLinearGradient(0,t,0,0);a.addColorStop(0,"rgba(37, 134, 255, 0.7)"),a.addColorStop(.5,"rgba(92, 195, 255, 0.8)"),a.addColorStop(1,"rgba(255, 255, 255, 0.9)"),s.beginPath(),s.moveTo(0,t);const n=e/r.length;for(let l=0;l<r.length;l++){const c=l*n,d=t-r[l]*t;s.lineTo(c,d)}s.lineTo(e,t),s.closePath(),s.fillStyle=a,s.fill(),s.beginPath(),s.moveTo(0,t);for(let l=0;l<r.length;l++){const c=l*n,d=t-r[l]*t;s.lineTo(c,d)}s.strokeStyle="rgba(255, 255, 255, 0.8)",s.lineWidth=2,s.stroke(),O(s,e,t,r,i)}function y(s,e,t){s.fillStyle="#2a2a2a",s.fillRect(0,0,e,t),k(s,e,t),E(s,t),A(s,e,t,{sample_rate:44100}),S(s,e,t,"Load an audio file to see the spectrum")}function S(s,e,t,o){s.fillStyle="#aaaaaa",s.font="16px Arial",s.textAlign="center",s.fillText(o,e/2,t/2)}function k(s,e,t){s.strokeStyle="rgba(100, 100, 100, 0.2)",s.lineWidth=1;for(let i=0;i<10;i++){const r=i*(t/10);s.beginPath(),s.moveTo(0,r),s.lineTo(e,r),s.stroke()}const o=[20,50,100,200,500,1e3,2e3,5e3,1e4,2e4];for(const i of o)if(i>=20&&i<=2e4){const r=C(i,e);s.beginPath(),s.moveTo(r,0),s.lineTo(r,t),s.strokeStyle=i%1e3===0?"rgba(150, 150, 150, 0.3)":"rgba(100, 100, 100, 0.2)",s.stroke()}}function E(s,e){s.fillStyle="#aaaaaa",s.font="12px Arial",s.textAlign="left";const t=[0,.25,.5,.75,1];for(const o of t){const i=e-o*e,r=Math.round(o*100)+"%";s.fillRect(0,i,4,1),s.fillText(r,7,i+4)}}function A(s,e,t,o){if(!o.sample_rate)return;s.fillStyle="#aaaaaa",s.font="12px Arial",s.textAlign="center";const i=[20,50,100,200,500,1e3,2e3,5e3,1e4,2e4];for(const r of i)if(r>=20&&r<=2e4){const a=C(r,e);let n;r>=1e3?n=`${r/1e3}kHz`:n=`${r}Hz`,[20,100,1e3,1e4,2e4].includes(r)&&s.fillText(n,a,t-5)}}function O(s,e,t,o,i){if(!i.sample_rate)return;const r=_(o,.5,Math.floor(o.length/50));if(r.length===0)return;const a=i.sample_rate/2;s.fillStyle="rgba(255, 220, 100, 0.9)",s.font="10px Arial",s.textAlign="center";for(const n of r){const l=n*(e/o.length),c=t-o[n]*t;s.beginPath(),s.arc(l,c,3,0,Math.PI*2),s.fill();const d=n/o.length,p=20,h=a,f=Math.log10(p),m=Math.log10(h),P=f+d*(m-f),b=Math.pow(10,P);let v;b>=1e3?v=`${(b/1e3).toFixed(1)}kHz`:v=`${Math.round(b)}Hz`,s.fillText(v,l,c-10)}}function C(s,e){const i=Math.log10(20),a=Math.log10(2e4)-i;return(Math.log10(s)-i)/a*e}function z(s,e){if(s.length<=e)return s;const t=new Float32Array(s.length);for(let o=0;o<e-1;o++)t[o]=s[o];for(let o=e-1;o<s.length;o++){let i=0;for(let r=0;r<e;r++)i+=s[o-r];t[o]=i/e}return t}function _(s,e,t){const o=[],i=e;for(let r=1;r<s.length-1&&!(s[r]>s[r-1]&&s[r]>s[r+1]&&s[r]>=i&&o.every(n=>Math.abs(r-n)>=t)&&(o.push(r),o.length>=5));r++);return o}class R extends HTMLElement{shadowRoot;canvas;ctx;audioService=null;constructor(){super(),this.shadowRoot=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupCanvas(),y(this.ctx,this.canvas.width,this.canvas.height)}render(){this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
          margin: 25px 0;
    ...
    `}setupCanvas(){this.canvas=this.shadowRoot.getElementById("spectrumCanvas"),this.ctx=this.canvas.getContext("2d"),new ResizeObserver(t=>{for(const o of t){const{width:i}=o.contentRect;this.canvas.width=i,this.updateSpectrum(this.audioService)}}).observe(this.canvas)}updateSpectrum(e){if(this.audioService=e,!e){y(this.ctx,this.canvas.width,this.canvas.height);return}try{const t=e.getInfo(),o=this.canvas.width,i=e.getSpectrumData(0,o,!0);I(this.ctx,this.canvas.width,this.canvas.height,i,t)}catch(t){console.error("Error drawing spectrum:",t),y(this.ctx,this.canvas.width,this.canvas.height)}}}customElements.define("spectrum-visualizer",R);class u extends HTMLElement{root;audioService=null;controls=new Map;constructor(){super(),this.root=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupEventListeners()}setAudioService(e){this.audioService=e}render(){const e=this.getConfig();this.root.innerHTML=`
      <style>
        ${this.getStyles()}
      </style>
    ...
    `}setupEventListeners(){const e=this.getConfig();e.controls.forEach(o=>{if(o.type==="slider"){const i=this.controls.get(o.id),r=this.root.getElementById(`${o.id}Value`);i&&r&&i.addEventListener("input",()=>{const a=parseFloat(i.value);r.textContent=this.formatValue(a,o.unit)})}}),this.root.getElementById("applyButton")?.addEventListener("click",()=>{if(!this.audioService){console.error("Audio service not set");return}const o={};e.controls.forEach(i=>{const r=this.controls.get(i.id);if(r)switch(i.type){case"slider":case"number":o[i.id]=parseFloat(r.value);break;case"checkbox":o[i.id]=r.checked;break;case"select":case"text":o[i.id]=r.value;break}});try{this.onApply(o),this.dispatchEvent(new CustomEvent("operationApplied",{detail:{operation:e.name,values:o},bubbles:!0,composed:!0}))}catch(i){console.error(`Error applying ${e.name}:`,i)}})}formatValue(e,t){return t==="Hz"&&e>=1e3?`${(e/1e3).toFixed(1)} kHz`:t==="%"?`${e}%`:t?`${e} ${t}`:e.toString()}getStyles(){return`
      :host {
        display: block;
      }
    ...
    `}}customElements.define("chord-filter-operation",J);class Z extends u{convolveFile=null;getConfig(){return{name:"Convolution",description:"Convolve or correlate your audio with another audio file.",controls:[{type:"select",id:"mode",label:"Operation Mode",defaultValue:"convolve",options:[{value:"convolve",label:"Convolution"},{value:"correlate",label:"Correlation"}],help:"Convolution time-reverses the IR before multiplying spectra"},{type:"slider",id:"wetMix",label:"Wet/Dry Mix",min:0,max:1,step:.01,defaultValue:1,help:"0 = 100% dry (original), 1 = 100% wet (processed)"}]}}connectedCallback(){super.connectedCallback(),this.addFileInput()}addFileInput(){const e=this.root.querySelector(".controls-container");if(e){e.insertAdjacentHTML("afterbegin",`
      ...
      `);const o=this.root.getElementById("convolveFile"),i=this.root.getElementById("selectFileButton"),r=this.root.getElementById("fileInfo");i?.addEventListener("click",()=>o.click()),o.addEventListener("change",a=>{const n=a.target;if(n.files&&n.files.length>0){this.convolveFile=n.files[0];const l=(this.convolveFile.size/1024).toFixed(1);r.textContent=`${this.convolveFile.name} (${l} KB)`}})}}async onApply(e){if(!this.convolveFile)throw new Error("Please select a file for convolution");const t=await this.convolveFile.arrayBuffer(),o=new Uint8Array(t),i=e.mode==="correlate";await this.audioService.convolveWithFile(o,i,e.wetMix)}getStyles(){return super.getStyles()+`
      .file-input-group {
        margin-bottom: 15px;
        padding-bottom: 15px;
    ...
    `,this.statusElement=this.shadowRoot.getElementById("statusElement")}setStatus(e,t="info",o=!1){this.timeoutId&&(clearTimeout(this.timeoutId),this.timeoutId=null),this.statusElement.textContent=e,this.statusElement.className="status",t==="error"?this.statusElement.classList.add("error"):t==="success"&&this.statusElement.classList.add("success"),this.statusElement.classList.remove("hidden"),(o||t==="success")&&(this.timeoutId=window.setTimeout(()=>{this.statusElement.classList.add("hidden")},5e3))}}customElements.define("status-bar",te);async function w(){const s=document.getElementById("app");if(!s){console.error("App element not found!");return}try{s.innerHTML='<div class="loading">Loading WASM module...</div>',console.log("Initializing WASM..."),await x.initialize(),console.log("WASM initialized successfully"),s.innerHTML="";const e=document.createElement("audio-processor-app");s.appendChild(e),console.log("App component mounted")}catch(e){console.error("Failed to initialize application:",e),s.innerHTML=`
      <div class="error">
