(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();const F="modulepreload",$=function(i){return"/mammut-fft/"+i},g={},q=function(e,t,o){let s=Promise.resolve();if(t&&t.length>0){let a=function(c){return Promise.all(c.map(d=>Promise.resolve(d).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=n?.nonce||n?.getAttribute("nonce");s=a(t.map(c=>{if(c=$(c),c in g)return;g[c]=!0;const d=c.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const h=document.createElement("link");if(h.rel=d?"stylesheet":F,d||(h.as="script"),h.crossOrigin="",h.href=c,l&&h.setAttribute("nonce",l),document.head.appendChild(h),d)return new Promise((f,m)=>{h.addEventListener("load",f),h.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(a){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=a,window.dispatchEvent(n),!n.defaultPrevented)throw a}return s.then(a=>{for(const n of a||[])n.status==="rejected"&&r(n.reason);return e().catch(r)})};class x{static wasmModule=null;static initPromise=null;static async initialize(){if(this.initPromise)return this.initPromise;this.initPromise=this.loadWasm(),await this.initPromise}static async loadWasm(){const{default:e,WasmAudioProcessor:t}=await q(async()=>{const{default:o,WasmAudioProcessor:s}=await import("./mammut_fft_web-BgmTlD3H.js");return{default:o,WasmAudioProcessor:s}},[]);await e(),this.wasmModule={WasmAudioProcessor:t}}static createProcessor(){if(!this.wasmModule)throw new Error("WASM module not initialized");return new this.wasmModule.WasmAudioProcessor}}class P extends EventTarget{processor;audioContext=null;currentFileName="";constructor(){super(),this.processor=x.createProcessor()}async loadAudioFile(e,t){this.currentFileName=e.name,this.audioContext||(this.audioContext=new AudioContext);const o=await e.arrayBuffer(),s=new Uint8Array(o);try{this.processor.read_audio_bytes(s,t),this.dispatchEvent(new CustomEvent("audioLoaded",{detail:{fileName:e.name,info:this.getInfo()}}))}catch(r){throw new Error(`Failed to load audio: ${r}`)}}getInfo(){return this.processor.get_info()}getSpectrumData(e,t,o){return this.processor.get_spectrum_data(e,t,o)}async processAudio(){this.processor.perform_ifft();const e=this.processor.get_processed_audio_normalized();if(!this.audioContext)throw new Error("Audio context not initialized");const t=this.getInfo(),o=t.channels,s=e.length/o,r=this.audioContext.createBuffer(o,s,t.sample_rate);for(let a=0;a<o;a++){const n=r.getChannelData(a);for(let l=0;l<s;l++)n[l]=e[l*o+a]}return this.audioBufferToWav(r)}downloadProcessedAudio(e){const t=this.processor.save_to_wav_bytes(),o=new Blob([t],{type:"audio/wav"}),s=URL.createObjectURL(o),r=e||(this.currentFileName?`${this.currentFileName.replace(/\.[^/.]+$/,"")}_processed.wav`:"processed_audio.wav"),a=document.createElement("a");a.href=s,a.download=r,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(s)}reset(){this.processor.reset(),this.dispatchEvent(new Event("reset"))}applyPower(e){this.processor.apply_pow(e),this.dispatchEvent(new Event("operationApplied"))}applyLowpass(e){this.processor.apply_lowpass(e),this.dispatchEvent(new Event("operationApplied"))}applyHighpass(e){this.processor.apply_highpass(e),this.dispatchEvent(new Event("operationApplied"))}applyBandpass(e,t){this.processor.apply_bandpass(e,t),this.dispatchEvent(new Event("operationApplied"))}audioBufferToWav(e){const t=e.numberOfChannels,o=e.length*t*2,s=e.sampleRate,r=new ArrayBuffer(44+o),a=new DataView(r),n=(c,d)=>{for(let p=0;p<d.length;p++)a.setUint8(c+p,d.charCodeAt(p))};n(0,"RIFF"),a.setUint32(4,36+o,!0),n(8,"WAVE"),n(12,"fmt "),a.setUint32(16,16,!0),a.setUint16(20,1,!0),a.setUint16(22,t,!0),a.setUint32(24,s,!0),a.setUint32(28,s*t*2,!0),a.setUint16(32,t*2,!0),a.setUint16(34,16,!0),n(36,"data"),a.setUint32(40,o,!0);let l=44;for(let c=0;c<e.length;c++)for(let d=0;d<t;d++){const p=Math.max(-1,Math.min(1,e.getChannelData(d)[c])),h=p<0?p*32768:p*32767;a.setInt16(l,h,!0),l+=2}return r}destroy(){this.processor.free()}applyPhaseMultiply(e){this.processor.apply_phase_multiply(e),this.dispatchEvent(new Event("operationApplied"))}applySpectrumShift(e){this.processor.apply_spectrum_shift(e),this.dispatchEvent(new Event("operationApplied"))}applyStretch(e){this.processor.apply_stretch(e),this.dispatchEvent(new Event("operationApplied"))}applyWobble(e,t){this.processor.apply_wobble(e,t),this.dispatchEvent(new Event("operationApplied"))}applyThreshold(e,t){this.processor.apply_threshold(e,t),this.dispatchEvent(new Event("operationApplied"))}applyAmplitudeDerivative(e){this.processor.apply_amplitude_derivative(e),this.dispatchEvent(new Event("operationApplied"))}keepPeaks(){this.processor.keep_peaks(),this.dispatchEvent(new Event("operationApplied"))}swapBins(e,t){this.processor.swap_bins(e,t),this.dispatchEvent(new Event("operationApplied"))}swapChannels(e){this.processor.swap_channels(e),this.dispatchEvent(new Event("operationApplied"))}applyChordFilter(e,t,o,s){if(e.length!==5||t.length!==5)throw new Error("Chord filter requires exactly 5 frequencies and amplitudes");this.processor.apply_chord_filter(e[0],t[0],e[1],t[1],e[2],t[2],e[3],t[3],e[4],t[4],o,s),this.dispatchEvent(new Event("operationApplied"))}prepareSplitPart(e,t,o){this.processor.prepare_split_part(e,t,o)}resetSplit(){this.processor.reset_split()}async convolveWithFile(e,t,o){this.processor.convolve_with_file(e,t,o),this.dispatchEvent(new Event("operationApplied"))}}class B extends HTMLElement{audioService;constructor(){super(),this.audioService=new P}connectedCallback(){this.render(),this.setupEventListeners()}disconnectedCallback(){this.audioService.destroy()}render(){this.innerHTML=`
    ...
    `,this.audio=this.root.getElementById("audioPlayer"),this.processButton=this.root.getElementById("processButton"),this.resetButton=this.root.getElementById("resetButton"),this.downloadButton=this.root.getElementById("downloadButton")}setupEventListeners(){this.processButton.addEventListener("click",()=>{this.dispatchEvent(new Event("processAudio",{bubbles:!0,composed:!0}))}),this.resetButton.addEventListener("click",()=>{this.dispatchEvent(new Event("resetAudio",{bubbles:!0,composed:!0}))}),this.downloadButton.addEventListener("click",()=>{this.dispatchEvent(new Event("downloadAudio",{bubbles:!0,composed:!0}))})}updateAudio(e){const t=new Blob([e],{type:"audio/wav"}),o=URL.createObjectURL(t);this.audio.src&&this.audio.src.startsWith("blob:")&&URL.revokeObjectURL(this.audio.src),this.audio.src=o}setEnabled(e){this.processButton.disabled=!e,this.resetButton.disabled=!e,this.downloadButton.disabled=!e}}customElements.define("audio-player",M);function I(i,e,t,o,s){if(i.fillStyle="#2a2a2a",i.fillRect(0,0,e,t),!o||o.length===0){S(i,e,t,"No spectrum data available");return}E(i,e,t),k(i,t),A(i,e,t,s);const r=R(o,3),a=i.createLinearGradient(0,t,0,0);a.addColorStop(0,"rgba(37, 134, 255, 0.7)"),a.addColorStop(.5,"rgba(92, 195, 255, 0.8)"),a.addColorStop(1,"rgba(255, 255, 255, 0.9)"),i.beginPath(),i.moveTo(0,t);const n=e/r.length;for(let l=0;l<r.length;l++){const c=l*n,d=t-r[l]*t;i.lineTo(c,d)}i.lineTo(e,t),i.closePath(),i.fillStyle=a,i.fill(),i.beginPath(),i.moveTo(0,t);for(let l=0;l<r.length;l++){const c=l*n,d=t-r[l]*t;i.lineTo(c,d)}i.strokeStyle="rgba(255, 255, 255, 0.8)",i.lineWidth=2,i.stroke(),z(i,e,t,r,s)}function y(i,e,t){i.fillStyle="#2a2a2a",i.fillRect(0,0,e,t),E(i,e,t),k(i,t),A(i,e,t,{sample_rate:44100}),S(i,e,t,"Load an audio file to see the spectrum")}function S(i,e,t,o){i.fillStyle="#aaaaaa",i.font="16px Arial",i.textAlign="center",i.fillText(o,e/2,t/2)}function E(i,e,t){i.strokeStyle="rgba(100, 100, 100, 0.2)",i.lineWidth=1;for(let s=0;s<10;s++){const r=s*(t/10);i.beginPath(),i.moveTo(0,r),i.lineTo(e,r),i.stroke()}const o=[20,50,100,200,500,1e3,2e3,5e3,1e4,2e4];for(const s of o)if(s>=20&&s<=2e4){const r=C(s,e);i.beginPath(),i.moveTo(r,0),i.lineTo(r,t),i.strokeStyle=s%1e3===0?"rgba(150, 150, 150, 0.3)":"rgba(100, 100, 100, 0.2)",i.stroke()}}function k(i,e){i.fillStyle="#aaaaaa",i.font="12px Arial",i.textAlign="left";const t=[0,.25,.5,.75,1];for(const o of t){const s=e-o*e,r=Math.round(o*100)+"%";i.fillRect(0,s,4,1),i.fillText(r,7,s+4)}}function A(i,e,t,o){if(!o.sample_rate)return;i.fillStyle="#aaaaaa",i.font="12px Arial",i.textAlign="center";const s=[20,50,100,200,500,1e3,2e3,5e3,1e4,2e4];for(const r of s)if(r>=20&&r<=2e4){const a=C(r,e);let n;r>=1e3?n=`${r/1e3}kHz`:n=`${r}Hz`,[20,100,1e3,1e4,2e4].includes(r)&&i.fillText(n,a,t-5)}}function z(i,e,t,o,s){if(!s.sample_rate)return;const r=_(o,.5,Math.floor(o.length/50));if(r.length===0)return;const a=s.sample_rate/2;i.fillStyle="rgba(255, 220, 100, 0.9)",i.font="10px Arial",i.textAlign="center";for(const n of r){const l=n*(e/o.length),c=t-o[n]*t;i.beginPath(),i.arc(l,c,3,0,Math.PI*2),i.fill();const d=n/o.length,p=20,h=a,f=Math.log10(p),m=Math.log10(h),L=f+d*(m-f),b=Math.pow(10,L);let v;b>=1e3?v=`${(b/1e3).toFixed(1)}kHz`:v=`${Math.round(b)}Hz`,i.fillText(v,l,c-10)}}function C(i,e){const s=Math.log10(20),a=Math.log10(2e4)-s;return(Math.log10(i)-s)/a*e}function R(i,e){if(i.length<=e)return i;const t=new Float32Array(i.length);for(let o=0;o<e-1;o++)t[o]=i[o];for(let o=e-1;o<i.length;o++){let s=0;for(let r=0;r<e;r++)s+=i[o-r];t[o]=s/e}return t}function _(i,e,t){const o=[],s=e;for(let r=1;r<i.length-1&&!(i[r]>i[r-1]&&i[r]>i[r+1]&&i[r]>=s&&o.every(n=>Math.abs(r-n)>=t)&&(o.push(r),o.length>=5));r++);return o}class H extends HTMLElement{shadowRoot;canvas;ctx;audioService=null;constructor(){super(),this.shadowRoot=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupCanvas(),y(this.ctx,this.canvas.width,this.canvas.height)}render(){this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
          margin: 25px 0;
    ...
    `}setupCanvas(){this.canvas=this.shadowRoot.getElementById("spectrumCanvas"),this.ctx=this.canvas.getContext("2d"),new ResizeObserver(t=>{for(const o of t){const{width:s}=o.contentRect;this.canvas.width=s,this.updateSpectrum(this.audioService)}}).observe(this.canvas)}updateSpectrum(e){if(this.audioService=e,!e){y(this.ctx,this.canvas.width,this.canvas.height);return}try{const t=e.getInfo(),o=this.canvas.width,s=e.getSpectrumData(0,o,!0);I(this.ctx,this.canvas.width,this.canvas.height,s,t)}catch(t){console.error("Error drawing spectrum:",t),y(this.ctx,this.canvas.width,this.canvas.height)}}}customElements.define("spectrum-visualizer",H);class u extends HTMLElement{root;audioService=null;controls=new Map;constructor(){super(),this.root=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupEventListeners()}setAudioService(e){this.audioService=e}render(){const e=this.getConfig();this.root.innerHTML=`
      <style>
        ${this.getStyles()}
      </style>
